...
WebUI.click(findTestObject('Object Repository/Page_Konversi Kuliah Mahasiswa  Kampus Merd_962c8e/a_Konversi Kuliah Mahasiswa_bukaSimpamButton'))

WebUI.click(findTestObject('Object Repository/Page_Konversi Kuliah Mahasiswa  Kampus Merd_962c8e/button_Ya, Buka'))
