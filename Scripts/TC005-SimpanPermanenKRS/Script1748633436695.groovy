...
WebUI.click(findTestObject('Page_Konversi Kuliah Mahasiswa  Kampus Merd_962c8e/a_Konversi Kuliah Mahasiswa_simpanButton'))

WebUI.click(findTestObject('Page_Konversi Kuliah Mahasiswa  Kampus Merd_962c8e/button_Ya, Simpan'))
