...
WebUI.click(findTestObject('Object Repository/Page_Dashboard Admin  Kampus Merdeka - Univ_69d92e/a_Nilai Konversi'))

WebUI.click(findTestObject('Object Repository/Page_Konversi Nilai Kuliah Mahasiswa  Kampu_3d4d49/a_Sinkronisasi Siakadu'))

WebUI.click(findTestObject('Object Repository/Page_Konversi Nilai Kuliah Mahasiswa  Kampu_3d4d49/button_Ya, sinkronisasi'))
